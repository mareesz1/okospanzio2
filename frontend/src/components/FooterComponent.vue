...
<div class="mt-5 footer" >
  ...
  <footer
    ...
    <section
             ...
             style="background-color: #3bc2eb"
             >
      <!-- Left -->
      <div class="me-5">
        <span>Keress minket a közösségi oldalakon is:</span>
      </div>
      <!-- Left -->
      ...
      <div>
        ...
        <a href="https://twitter.com/home" target="_blank" class="text-white me-4">
        ...
        <a href="https://github.com/mareesz1/okospanzio2" target="_blank" class="text-white me-4">
        ...
        <a href="https://media.tenor.com/kzwbaa-Gg2QAAAAd/women-hahaha-women-memes.gif" target="_blank" class="text-white me-4">
      ...
      <div class="container text-center text-md-start mt-5">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            <!-- Content -->
            <h6 class="text-uppercase fw-bold">Okospanzió</h6>
            <hr
                class="mb-4 mt-0 d-inline-block mx-auto"
                style="width: 60px; background-color: #7c4dff; height: 2px"
                />
            <p>
              A weboldalt készítette Mike Marcell, Csanda Norbert és Nagy Gergő. A weboldallal egy személyzet nélküli okospanzió modellezését szeretnénk kivitelezni.
            </p>
          </div>
          <!-- Grid column -->
